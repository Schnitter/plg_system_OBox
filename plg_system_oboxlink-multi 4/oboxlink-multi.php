...
class PlgSystemOboxlinkMulti extends CMSPlugin
{
    public function onAfterRender()
    {
        ...
        // Links aus Plugin-Parametern holen
        ...
        if (!empty($links)) {
            ...
            foreach ($links as $link) {
                ...
                $bgColor = htmlspecialchars($link['bg_color'] ?? '#f5f5f5');
                $borderColor = htmlspecialchars($link['border_color'] ?? '#007BFF');
                $iconColor = htmlspecialchars($link['icon_color'] ?? $borderColor);
                ...
                ">
                    <span style="font-size:18px; margin-right:10px; color:' . $iconColor . ';">
                        <i class="' . $icon . '"></i>
                    </span>
